...
//
//
RequestRingBufferFaRM*
AllocateRequestBufferFaRM(
	BufferT BufferAddress
) {
	RequestRingBufferFaRM* ringBuffer = (RequestRingBufferFaRM*)BufferAddress;

	memset(ringBuffer, 0, sizeof(RequestRingBufferFaRM));
