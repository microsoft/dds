...
//
// TLDK supports DPDK up to 20.05, but DEQUEUE_PTRS expired since DPDK 20.08
// In order for TLDK to work with BF-2's native DPDK is 20.11
// Add back ENQUEUE_PTRS and DEQUEUE_PTRS from DPDK 20.05
